...
from vocalance.app.config.os_defaults import running_on_macos


def _action(windows: str, macos: str) -> str:
    return macos if running_on_macos() else windows


class AutomationCommandRegistry:
    """Built-in voice automation commands and helpers for lookup and protected phrases."""

    _MACOS_EXCLUDED_COMMAND_KEYS = frozenset({"right desk", "left desk"})

    @staticmethod
    def _build_default_commands() -> List[AutomationCommand]:
        commands = [
            ExactMatchCommand(
                command_key="web open",
                action_type="hotkey",
                action_value=_action("ctrl+t", "command+t"),
            ...
            ExactMatchCommand(
                ...
                action_type="hotkey",
                action_value=_action("ctrl+w", "command+w"),
            ...
            ExactMatchCommand(
                command_key="close",
                action_type="hotkey",
                action_value=_action("alt+f4", "command+w"),
            ...
            ExactMatchCommand(
                ...
                action_type="hotkey" if running_on_macos() else "key_sequence",
                action_value=_action("alt+space, n", "command+m"),
            ...
            ExactMatchCommand(
                ...
                action_type="hotkey",
                action_value=_action("ctrl+shift+t", "command+shift+t"),
            ...
            ExactMatchCommand(
                ...
                action_type="hotkey",
                action_value=_action("ctrl+tab", "control+tab"),
            ...
            ExactMatchCommand(
                ...
                action_type="hotkey",
                action_value=_action("ctrl+shift+tab", "control+shift+tab"),
            ...
            ExactMatchCommand(
                command_key="save",
                action_type="hotkey",
                action_value=_action("ctrl+s", "command+s"),
            ...
            ExactMatchCommand(
                ...
                action_type="hotkey",
                action_value=_action("ctrl+alt+s", "command+alt+s"),
            ...
            ExactMatchCommand(
                ...
                action_type="hotkey",
                action_value=_action("ctrl+m+w", "command+k+w"),
            ...
            ExactMatchCommand(
                command_key="copy",
                action_type="hotkey",
                action_value=_action("ctrl+c", "command+c"),
            ...
            ExactMatchCommand(
                command_key="paste",
                action_type="hotkey",
                action_value=_action("ctrl+v", "command+v"),
            ...
            ExactMatchCommand(
                ...
                action_type="hotkey",
                action_value=_action("ctrl+a", "command+a"),
            ...
            ExactMatchCommand(
                command_key="wipe",
                action_type="hotkey",
                action_value=_action("ctrl+z", "command+z"),
            ...
            ExactMatchCommand(
                command_key="redo",
                action_type="hotkey",
                action_value=_action("ctrl+y", "command+shift+z"),
            ...
            ExactMatchCommand(
                command_key="zoom",
                action_type="hotkey",
                action_value=_action("ctrl++", "command++"),
            ...
            ExactMatchCommand(
                ...
                action_type="hotkey",
                action_value=_action("ctrl+alt+.", "command+alt+."),
            ...
            ExactMatchCommand(
                ...
                action_type="hotkey",
                action_value=_action("ctrl+i", "command+i"),
            ...
            ExactMatchCommand(
                ...
                action_type="hotkey",
                action_value=_action("ctrl+n", "command+n"),
            ...
            ExactMatchCommand(
                ...
                action_type="hotkey",
                action_value=_action("ctrl+y", "command+y"),
            ...
            ExactMatchCommand(
                ...
                action_type="hotkey",
                action_value=_action("ctrl+shift+y", "command+shift+y"),
            ...
            ExactMatchCommand(
                ...
                action_type="hotkey",
                action_value=_action("ctrl+shift+n", "command+shift+n"),
            ...
            ExactMatchCommand(
                ...
                action_type="hotkey",
                action_value=_action("ctrl+enter", "command+enter"),
                short_description="Keep File",
            ...
            ExactMatchCommand(
                ...
                action_type="hotkey",
                action_value=_action("ctrl+shift+backspace", "command+shift+backspace"),
                short_description="Reject File",
            ...
            ExactMatchCommand(
                ...
                action_type="hotkey",
                action_value=_action("ctrl+alt+p", "command+alt+p"),
            ...
            ExactMatchCommand(
                command_key="search",
                action_type="hotkey",
                action_value=_action("ctrl+f", "command+f"),
            ...
            ExactMatchCommand(
                ...
                action_type="hotkey",
                action_value=_action("ctrl+shift+f", "command+shift+f"),
            ...
            ExactMatchCommand(
                command_key="back",
                action_type="hotkey",
                action_value=_action("alt+left", "command+["),
            ...
            ExactMatchCommand(
                command_key="jet",
                action_type="hotkey",
                action_value=_action("alt+right", "command+]"),
            ...
            ExactMatchCommand(
                ...
                action_type="hotkey",
                action_value=_action("ctrl+k", "command+k"),
                short_description="Ask AI",
            ...
            ExactMatchCommand(
                command_key="old",
                action_type="hotkey",
                action_value=_action("ctrl+pageup", "control+pageup"),
            ...
            ExactMatchCommand(
                command_key="new",
                action_type="hotkey",
                action_value=_action("ctrl+pagedown", "control+pagedown"),
            ...
            ExactMatchCommand(
                command_key="explore",
                action_type="hotkey",
                action_value=_action("ctrl+shift+e", "command+shift+e"),
            ...
            ExactMatchCommand(
                command_key="refresh",
                action_type="hotkey",
                action_value=_action("ctrl+r", "command+r"),
        ...
        if running_on_macos():
            return [c for c in commands if c.command_key not in AutomationCommandRegistry._MACOS_EXCLUDED_COMMAND_KEYS]
        return commands
    ...
    def get_default_commands(cls) -> List[AutomationCommand]:
        ...
        Returns:
            Copy of the default automation commands for the current OS.
        """
        return cls._build_default_commands()
    ...
    def get_commands_dict(cls) -> Dict[str, AutomationCommand]:
        ...
        """
        return {cmd.command_key: cmd for cmd in cls._build_default_commands()}
    ...
    def get_command_phrases(cls) -> List[str]:
        ...
        """
        return [cmd.command_key for cmd in cls._build_default_commands()]
